...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Nazar Empire"          # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Nazar Empire"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Nazar Empire",
            "welcome": "Welcome to Nazar Empire! Type your message or /help for commands.",
            "goodbye": "Goodbye! 🧿",
